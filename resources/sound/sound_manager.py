...
class SoundManager(Singleton):
    def __init__(self):
        self.sound_dict: dict[str, pygame.Sound] = {}
    ...
    def load_sound(self, path_to_sound: FileLike, sound_name: str) -> pygame.Sound:
        sound = pygame.Sound(path_to_sound)
        self.register_sound(sound, sound_name)

        return sound

    def register_sound(self, sound: pygame.Sound, sound_name: str) -> None:
        self.sound_dict[sound_name] = sound

    def get_sound(self, sound_name: str) -> pygame.Sound:
