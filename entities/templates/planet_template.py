...
def create_planet(entity_manager:EntityManager, position:tuple, radius:int, surface_image:pygame.Surface, atmosphere_radius:int, atmosphere_color:tuple):
    return create_entity(entity_manager, 
                         Position(position), 
                         Planet(radius, surface_image, atmosphere_radius, atmosphere_color),
